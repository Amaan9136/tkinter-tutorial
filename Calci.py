...
tk_calc = Tk()
tk_calc.configure(bg="#1e1e1e", bd=10)  # Darker background for a more modern feel
...
text_display = Entry(tk_calc, font=('Arial', 20, 'bold'), textvariable=text_input,
                     bd=5, insertwidth=5, bg='#293C4A', fg='white', justify='right',
                     width=60, highlightthickness=2, highlightbackground='#ffffff').grid(columnspan=5, padx=10, pady=15)

button_params = {'bd': 5, 'fg': 'white', 'bg': '#3C3636', 'font': ('Arial', 20, 'bold')}
button_params_main = {'bd': 5, 'fg': 'white', 'bg': '#495057', 'font': ('Arial', 20, 'bold')}
